...
// 	}
	...
	A3DSkinRenderBase* psr1 = g_pGame->GetSkinRender1();
...
bool CECWorld::RenderForReflected(A3DViewport* pViewport)
{
	...
	A3DSkinRenderBase* psr = g_pGame->GetSkinRender2();
	A3DSkinRenderBase* poldsr = g_pGame->GetA3DEngine()->GetA3DSkinMan()->GetCurSkinRender();
...
#ifdef ANGELICA_2_2
	D3DXSaveSurfaceToFile(_AL("D:\\dd.bmp"), D3DXIFF_BMP, pRenderTarget->GetTargetSurface()->m_pD3DSurface, NULL , NULL);
#else
