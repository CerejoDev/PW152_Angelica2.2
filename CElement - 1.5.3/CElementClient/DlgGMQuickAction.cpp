...
AUI_BEGIN_COMMAND_MAP(CDlgGMQuickAction, CDlgBase)
...
CDlgGMQuickAction::CDlgGMQuickAction()
{
}
...
bool CDlgGMQuickAction::OnInitDialog()
{
...
void CDlgGMQuickAction::OnShowDialog()
{
...
void CDlgGMQuickAction::OnCommand_SecretMsg(const char * szCommand)
{
	Show(false);
...
void CDlgGMQuickAction::OnCommand_Report(const char * szCommand)
{
...
void CDlgGMQuickAction::OnCommand_Extra(const char * szCommand)
{
...
void CDlgGMQuickAction::OnCommand_Trade(const char * szCommand)
{
	Show(false);
...
void CDlgGMQuickAction::OnCommand_AddFriend(const char * szCommand)
{
	int idTarget = GetData();
	const ACHAR *pszName = GetGameRun()->GetPlayerName(idTarget, true);
...
void CDlgGMQuickAction::OnCommand_InviteGroup(const char * szCommand)
{
	int idTarget = GetData();
...
void CDlgGMQuickAction::OnCommand_InviteGuild(const char * szCommand)
{
	int idTarget = GetData();
	const ACHAR *pszName = GetGameRun()->GetPlayerName(idTarget, true);
...
void CDlgGMQuickAction::OnCommand_Follow(const char * szCommand)
{
	int idTarget = GetData();
	const ACHAR *pszName = GetGameRun()->GetPlayerName(idTarget, true);
...
void CDlgGMQuickAction::OnCommand_JoinChannel(const char * szCommand)
{
	int idTarget = GetData();
	const ACHAR *pszName = GetGameRun()->GetPlayerName(idTarget, true);
	Show(false);
...
void CDlgGMQuickAction::OnCommand_InviteChannel(const char * szCommand)
{
	int idTarget = GetData();
...
void CDlgGMQuickAction::OnCommand_Bind(const char * szCommand)
{
	GetHostPlayer()->CmdBindBuddy(GetData());
	Show(false);
}

void CDlgGMQuickAction::OnCommand_Duel(const char * szCommand)
{
	GetHostPlayer()->CmdAskDuel(GetData());
	Show(false);
}

void CDlgGMQuickAction::OnCommand_EPEquip(const char * szCommand)
{
...
void CDlgGMQuickAction::OnCommand_ProfView(const char * szCommand)
{
...
void CDlgGMQuickAction::OnCommand_CANCEL(const char * szCommand)
{
	Show(false);
}

void CDlgGMQuickAction::OnCommand_CopyName(const char * szCommand)
{
...
void CDlgGMQuickAction::OnCommand_Whisper(const char * szCommand)
{
	Show(false);
...
void CDlgGMQuickAction::OnCommand_shop(const char * szCommand)
{
	//	打开对方的摆摊
