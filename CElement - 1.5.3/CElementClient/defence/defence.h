...
namespace PCInfo
{
	...
	{
	private:
		static const std::wstring GetRamSize();
		static const std::wstring GetHardDiskSerial();
		static const std::wstring GetCPUID();
		static const std::wstring GetPCName();
		static const std::wstring GetPCUser();

	public:
		static const std::wstring GetInfo();
	};
}
