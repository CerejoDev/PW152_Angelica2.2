...
#ifndef _AResECModel_H_
#define _AResECModel_H_
...
class AResEcm : public AResSingle
{
...
public:		//	Constructor and Destructor
	...
	explicit AResEcm(AResManager* pResMan);
	virtual ~AResEcm(void);
