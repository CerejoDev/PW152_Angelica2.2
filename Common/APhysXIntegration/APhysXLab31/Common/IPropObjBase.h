...
public:
	...
	IObjBase* GetRayHit(CPoint* poutPT) const;
	void SetRayHit(IObjBase* pNewHit, const CPoint& pt);
...
public:
	...
	AString		GetObjName()	const { return m_strObjName; }
	const char*	GetObjName_cstr() const { return m_strObjName.operator const char*(); }
...
protected:
	...
	void SetObjName(const char* szFile);
