...
CMainFrame::CMainFrame() : m_PopMenuIndex(5), m_PopMenuName("最近文档"), m_ConfigName("Configs\\APhysXLab31Config.ini")
{
...
{
	CALogWrapper::GetInstance()->SetOutputWnd(0);
...
int CMainFrame::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	if (!m_wndWorkSpace.Create (_T("分类显示"), this, CRect (0, 0, 200, 200),
	...
	CALogWrapper::GetInstance()->SetOutputWnd(&m_wndOutput);
	return 0;
}
