...
public:
	...
	bool GetLastRotateInfo(float& outAngleRadians, A3DVECTOR3& outLocalAxis, A3DVECTOR3& outGlobalAxis) const;
	bool GetLastScaleChange(float& outScaleChange) const;
...
private:
	...
	A3DVECTOR3 GetSelectedAxis() const;
...
private:
	...
	A3DMATRIX4 m_LastRotate;
	float m_LastRotateAngleRadians;
	float m_LastScaleChange;
};
