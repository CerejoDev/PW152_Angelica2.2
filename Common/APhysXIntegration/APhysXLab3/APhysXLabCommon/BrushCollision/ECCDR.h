...
bool VertTrace(BrushCollideParam *pParam, CDR_TRACE_OUTPUT& Out, float DeltaY=100.0f, bool* pStartSolid = NULL);

// only trace the building
bool RayTraceEnv(const A3DVECTOR3& vStart, const A3DVECTOR3& vDelta, A3DVECTOR3& vHitPos, A3DVECTOR3& vNormal, float& fraction, bool* pStartSolid = NULL );
