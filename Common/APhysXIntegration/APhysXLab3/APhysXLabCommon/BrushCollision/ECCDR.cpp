...
bool RayTraceEnv(
						  ...
						  A3DVECTOR3& vHitPos,
						  A3DVECTOR3& vNormal,
						  float& fraction, bool* pStartSolid 
						  )
{
	return GetCollisionSupplier()->RayTraceEnv(vStart, vDelta, vHitPos, vNormal, fraction, pStartSolid);
}

// 向下 Trace 地形和建筑，并返回第一个碰撞点的情况
bool VertRayTrace(const A3DVECTOR3& vPos, A3DVECTOR3& vHitPos, A3DVECTOR3& vHitNormal, float DeltaY, bool* pStartSolid )
{
	return GetCollisionSupplier()->VertRayTrace(vPos, vHitPos, vHitNormal, DeltaY, pStartSolid);		
}
...
{
	return GetCollisionSupplier()->CollideWithTerrain(vStart, vCenter, vDelta, fFraction, vHitNormal, bStart);
}
/*
