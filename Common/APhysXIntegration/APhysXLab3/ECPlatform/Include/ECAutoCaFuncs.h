/*
* FILE: ECAutoCaFuncs.h
*
* DESCRIPTION: Some math functions are used in AutoCa classes.
*
* CREATED BY: 
*
* HISTORY:
...
namespace ECP_AUTOCA
{
	...
	{
		return A3DVECTOR3((frandom01()-0.5), (ECP_AUTOCA::frandom01()-0.5), (frandom01()-0.5));
	}
