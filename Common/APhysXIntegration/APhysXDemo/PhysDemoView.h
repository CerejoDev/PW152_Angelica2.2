...
protected:
	...
	void ShootDummySphereFromEye(float fVelocity = 20.0f);
	...
	struct PhysObjItem
	{
		...
		PhysObjItem()
		{
			mObjType = -1;		// an invalid value...
		}
	};

	PhysObjItem m_LastAddedObjItem;
...
protected:
	...
	afx_msg void OnModePhysxprofile();
	afx_msg void OnUpdateModePhysxprofile(CCmdUI* pCmdUI);
	afx_msg void OnModePhysxdebugrender();
	afx_msg void OnUpdateModePhysxdebugrender(CCmdUI* pCmdUI);
	...
	afx_msg void OnEditPickandrotate();
	afx_msg void OnUpdateEditPickandrotate(CCmdUI* pCmdUI);
	afx_msg void OnEditPickandmove();
	afx_msg void OnUpdateEditPickandmove(CCmdUI* pCmdUI);
