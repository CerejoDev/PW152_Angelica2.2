...
class CPhysModelObject : public CPhysObject
{
	...
	DeclarePhysObjType(PHYS_OBJTYPE_SKELETON);
...
protected:	//	Attributes
	...
	CClothSkinConfig* m_pClothSkinConfig;
	int m_iClothSkinStartID;

	bool m_bOnPlayAction;
	A3DSkinModelActionCore* m_pCurAction;
	int m_iCurActionPlayTime;					// in (ms)


	int		m_iType;		//	Object type
	
	int m_iClothOnDelayTime;	// we will delay a time (in ms) when turning on the cloth simulation...
