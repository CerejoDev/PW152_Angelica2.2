...
#define FRIENDFUN friend bool VertRayTrace(const A3DVECTOR3& vPos, A3DVECTOR3& vHitPos, A3DVECTOR3& vHitNormal, float DeltaY);\
...
friend bool RayTraceEnv(const A3DVECTOR3& vStart, const A3DVECTOR3& vDelta, A3DVECTOR3& vHitPos, A3DVECTOR3& vNormal, float& fraction );\
...
public:
	...
	virtual void SkipMovingObjCollision(bool bSkip = true) {}
...
protected:
	...
	virtual bool CollideWithTerrain(const A3DVECTOR3& vStart, const A3DVECTOR3& vDelta, float& fFraction, A3DVECTOR3& vHitNormal, bool& bStart);
	...
	virtual bool VertRayTrace(const A3DVECTOR3& vPos, A3DVECTOR3& vHitPos, A3DVECTOR3& vHitNormal, float DeltaY );
	...
	////////////////////////////////////pure/////////////////////////////////////	
	virtual A3DTerrain2* GetTerrain() = 0;
	...
	virtual bool RayTraceEnv(const A3DVECTOR3& vStart,  const A3DVECTOR3& vDelta, A3DVECTOR3& vHitPos, A3DVECTOR3& vNormal, float& fraction) = 0;
	//called by CollideWithEnv and cdr
	virtual bool CollideWithBrush(BrushCollideParam *pParam) = 0;

public:
	virtual float GetWaterHeight(const A3DVECTOR3& vPos) = 0;
