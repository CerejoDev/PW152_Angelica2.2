...
{
public:
	virtual bool TickMove(int deltaT, A3DVECTOR3& vPos, A3DVECTOR3& vDir) = 0;
...
public:
	...
	virtual bool TickMove(int deltaT, A3DVECTOR3& vPos, A3DVECTOR3& vDir);
};
...
public:
	...
	bool TickMove(int deltaT, A3DVECTOR3& vPos, A3DVECTOR3& vDir);
