...
bool LineBrushMove::TickMove(int delta, A3DVECTOR3& vPos, A3DVECTOR3& vDir)
{
	A3DVECTOR3 step(vSpeed * (0.001f * delta));
...
bool CircleBrushMove::TickMove(int delta, A3DVECTOR3& vPos, A3DVECTOR3& vDir)
{
	A3DMATRIX4 mat;
	mat.RotateAxis(vCenter, vAxis, delta*0.001f*fSpeed);
	vPos = vPos * mat;
...
bool LineBrushMoveWithRot::TickMove(int delta, A3DVECTOR3& vPos, A3DVECTOR3& vDir)
{
	LineBrushMove::TickMove(delta, vPos, vDir);
	A3DMATRIX4 mat;
	mat.RotateY(delta * 0.001f * fRotSpeed);
	vDir = vDir * mat;
	return true;
}
...
bool BrushObjAttr::TickMove(int delta, A3DVECTOR3& vPos, A3DVECTOR3& vDir)
{
	if (m_pBrushMove)
		m_pBrushMove->TickMove(delta, vPos, vDir);
	return true;
}
