...
public:
	...
	A3DAABB   m_AABB;
	vector <ConvexBrushData > m_pBrushDatas;
...
private:
	...
	vector<CBrushCell::ConvexBrushData> m_OutOfRangeBrush; 
	...
	inline bool _AddBrush(CConvexBrush* pBrush, CBrushProvider* pProvider, const A3DAABB& aabb);
#if BMAN_VERBOSE_STAT
	CBManStat     m_Stat;
#endif	
