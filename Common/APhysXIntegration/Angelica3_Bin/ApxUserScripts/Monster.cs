...
public class Monster : CommonActorBehavior
{
    ...
    public override void Start()
    {
        ...
        // m_PhysXObj.SetDrivenMode(MDrivenMode.DRIVEN_BY_ANIMATION);
        base.Start();
        ...
        EyeshotRadius = 5;
//        SetAttackRadius(CurrentAttackInfo.infoAttack.mAttackRange);
    }
    ...
    public override void PreTick(float dtSec)
    {
        ...
        if (bIsAttackMA)
        {
            ...
            if (0.7 > rand.NextDouble())
                base.PlayAttack(hp, hd, MA.GetMActorBase(), 0);
            else
                base.PlayAttack(hp, hd, MA.GetMActorBase(), 1);
        } 
        else
        {
            if (QueryMoveState(CommonActorBehavior.MoveState.MS_STAND))
